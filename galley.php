...
$defaultCoverImage = 'assets/img/melchezed order.jpeg';
$galleryAlbums = [];

try {
  $db = getDB();
  $stmt = $db->query("SELECT title, description, google_photos_url, cover_image FROM gallery_albums WHERE status = 'active' ORDER BY display_order ASC, created_at DESC");
  $galleryAlbums = $stmt->fetchAll();
} catch (Exception $e) {
  error_log('Failed to load gallery albums: ' . $e->getMessage());
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>CrossLife service Gallery - we capture every moment</title>
      ...
      <div class="container d-flex justify-content-center position-relative">
        <nav id="navmenu" class="navmenu">
          <ul>
            ...
            <li><a href="galley.php" class="active">Gallery</a></li>
            <li class="nav-social-search">
              <div class="nav-icons">
               ...
               <li><a href="https://www.facebook.com/crosslife_tz" class="facebook" target="_blank" rel="noopener noreferrer"><i class="bi bi-facebook"></i></a></li>
                <li></li><a href="https://www.instagram.com/crosslife_tz" class="instagram" target="_blank" rel="noopener noreferrer"><i class="bi bi-instagram"></i></a></li>
               <li></li> <a href="https://www.youtube.com/@CrossLifeTV" class="youtube" target="_blank" rel="noopener noreferrer"><i class="bi bi-youtube"></i></a></li>
               <li></li> <a href="https://www.tiktok.com/@CrossLife" class="tiktok" target="_blank" rel="noopener noreferrer"><i class="bi bi-tiktok"></i></a></li>
      ...
      <div class="slideshow-background">
        <div class="slideshow-container">
          <div class="slide active">
            <img src="assets/img/slideshow/elikana.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/elim0ses.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/eliza.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/elizab.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/grace.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/biblec.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/kenValence.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/lenhard.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/sou.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/uweponi.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/_MG_4997.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
          <div class="slide">
            <img src="assets/img/slideshow/venelanda.jpg" alt="CrossLife Mission Network" class="slide-image">
          </div>
        </div>
      ...
      <div class="hero-content">
        ...
        <div class="container position-relative">
          <div class="row justify-content-center text-center">
            <div class="col-lg-8">
              <h1 data-aos="fade-up" data-aos-delay="100">CrossLife Service Gallery</h1>
              <p data-aos="fade-up" data-aos-delay="200">Every photo 📸 tells a story of faith, joy  and transformation a reminder that God is present not only in the message but in every lifted hand 🙌, every prayer 🙏 and every shared smile 😊. This gallery stands as a testimony 🔥 of what happens when hearts gather in His presence celebrating life, community and the living presence of Elohim among us.</p>
            </div>
          </div>
        </div>
...
<section id="what-we-do" class="what-we-do section">
      <div class="container section-title" data-aos="fade-up">
        <span class="subtitle">Rising Sons, Revealing Christ</span>
        <h2><span style="letter-spacing: 5px;">YEAR OF MELCHIZEDEK ORDER</span> </h2>
        <p> 2026 is our divinely appointed year to walk as kings and priests, revealing Christ, representing His Kingdom, manifesting spiritual authority, and experiencing supernatural realities as our natural daily life fully. </p>
      </div>
      <section>
        ...
        <div class="row g-4">
          ...
          <div class="col-12" data-aos="fade-up" data-aos-delay="150">
            <div class="feature-card activity-card h-100">
              <img src="<?php echo htmlspecialchars($defaultCoverImage, ENT_QUOTES); ?>" class="card-img-top" alt="Gallery album placeholder">
              <div class="card-body">
                <h5 class="card-title">
                  <i class="bi bi-images"></i> Album content coming soon
                </h5>
                <p class="card-text">Add albums from the admin panel to publish custom titles, descriptions, and Google Photos links here.</p>
              </div>
              <div class="card-footer text-center">
                <a href="contacts.html" class="btn btn-activity">Download</a>
              </div>
            </div>
          </div>
          <?php else: ?>
            <?php foreach ($galleryAlbums as $index => $album): ?>
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="<?php echo 120 + (($index % 3) * 50); ?>">
            <div class="feature-card activity-card h-100">
              <img src="<?php echo htmlspecialchars($album['cover_image'] ?: $defaultCoverImage, ENT_QUOTES); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($album['title'], ENT_QUOTES); ?>">
              <div class="card-body">
                <h5 class="card-title">
                  <i class="bi bi-images"></i> <?php echo htmlspecialchars($album['title'], ENT_QUOTES); ?>
                </h5>
                <p class="card-text">
                  <?php echo nl2br(htmlspecialchars($album['description'] ?? '', ENT_QUOTES)); ?>
                </p>
              </div>
              <div class="card-footer text-center">
                <a href="<?php echo htmlspecialchars($album['google_photos_url'], ENT_QUOTES); ?>" target="_blank" rel="noopener noreferrer" class="btn btn-activity">Download</a>
              </div>
            </div>
          </div>
            <?php endforeach; ?>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const searchableSections = [
        ...
        { id: 'statement-of-faith', title: 'Statement of Faith', keywords: 'statement of faith convictions beliefs doctrine scripture godhead jesus holy spirit', page: 'index.html' },
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (slides.length > 0) {
        ...
        function startSlideshow() {
          // Auto-advance every 8 seconds for slow, smooth transitions
