    ...
    <section id="sermons" class="sermons section">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <?php if (empty($allSermons)): ?>
          <!-- No sermons yet: show static promotional content -->
          <div class="row g-4 mb-5">
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
              <div class="sermon-type-card h-100">
                <div class="sermon-icon"><i class="bi bi-play-circle"></i></div>
                <h3>Video Sermons</h3>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
              <div class="sermon-type-card h-100">
                <div class="sermon-icon"><i class="bi bi-headphones"></i></div>
                <h3>Audio Sermons</h3>
                <p>Listen to our audio sermons and teachings. Stream or download audio content to listen on the go.</p>
                <div class="sermon-links mt-3">
                  <a href="contacts.html" class="btn btn-outline"><i class="bi bi-envelope me-2"></i>Contact for Audio Access</a>
                </div>
                <div class="sermon-image mt-4">
        ...
        <?php else: ?>
          ...
          <!-- Tab Content -->
          <div class="tab-content" id="sermonTabContent">
        ...
        <div class="col-lg-4">
          <div class="footer-contact">
            ...
            <div class="contact-item">
              ...
              <div class="contact-info"><p>Dar es Salaam<br>Tanzania</p></div>
            </div>
            <div class="contact-item">
              <div class="contact-icon"><i class="bi bi-telephone"></i></div>
              <div class="contact-info"><p>+255 (0)6 531 265 83<br>+255 (0)7 100 738 60</p></div>
            </div>
            <div class="contact-item">
              <div class="contact-icon"><i class="bi bi-envelope"></i></div>
              <div class="contact-info"><p>karibu@crosslife.org<br>lenhard.kyamba@crosslife.org</p></div>
            </div>
